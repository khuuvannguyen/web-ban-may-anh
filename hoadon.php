...
<body>
	...
	<?php 
		...
		try{
			$sql="select * from deta where MADH='".$MADH."' and ID='".$ID."'";
		...
		try{
			$sql="select * from giohang where MaDH='".$MADH."' and ID='".$ID."'";
	...
	<table border="1" align="center">
		...
		<tr>
			<td colspan="4">
				Họ và tên khách hàng: <?php try{echo $khachhang['HOTEN'];}catch(Exception $e){echo '<i>Quý khách chưa cập nhật thông tin</i>';} ?>
			</td>
			<td colspan="3">
				Giới tính: <?php try{echo $khachhang['GIOITINH'];}catch(Exception $e){echo '<i>Quý khách chưa cập nhật thông tin</i>';} ?>
			</td>
		</tr>
		<tr>
			<td colspan="4">
				Số điện thoại: <?php try{echo $khachhang['SDT'];}catch(Exception $e){echo '<i>Quý khách chưa cập nhật thông tin</i>';} ?>
			</td>
			<td colspan="3">
				Năm sinh: <?php try{echo $khachhang['NAMSINH'];}catch(Exception $e){echo '<i>Quý khách chưa cập nhật thông tin</i>';} ?>
			</td>
		</tr>
		<tr>
			<td colspan="7">
				Địa chỉ: <?php try{echo $khachhang['DIACHI'];}catch(Exception $e){echo '<i>Quý khách chưa cập nhật thông tin</i>';} ?>
			</td>
		</tr>
		<tr>
			<td colspan="4">
				<b>Mã đơn hàng: <?php try{echo $donhang['MaDH'];}catch(Exception $e){echo '<i>Quý khách chưa cập nhật thông tin</i>';} ?></b>
			</td>
			<td colspan="3">
				Ngày mua: <?php try{echo $donhang['NgayMua'];}catch(Exception $e){echo '<i>Quý khách chưa cập nhật thông tin</i>';} ?>
			</td>
		</tr>
		<tr>
			<td colspan="7">
