<?php session_start(); $nsx=$_REQUEST["camera"]; ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<?php echo '<title>Máy ảnh '.$nsx.'</title>'; ?>
...
<body>
	...
	<?php 
		...
		$sql="select * from sanpham where NhaSanXuat='".$nsx."'";
		...
		if(!isset($_GET['sort'])){
				...
				echo '<div class="container">';
					echo '<div class="row">';
						echo '<div class="col-12 text-center">';
							...
							echo 'Thử ';
							echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page=1">quay về đầu trang</a>';
							  echo ' hoặc <a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page='.$number_of_pages.'">đi tới cuối trang.</a>';
							  echo '</h1>';
						echo '</div>';
					echo '</div>';
				echo '</div>';
			...
			echo '<div class="container">';
				echo '<div class="row>';
					echo '<div class="container>';
						echo '<div class="col-12 text-center">';
							echo '<h1 class="gold-man display-4" style="text-transform: uppercase;font-size: 250%;"">'.$nsx.'</h1>';
						echo '</div>';
					echo '</div>';
				echo '</div>';
				echo '<div class="row mb-2">';
					echo '<div class="col-12 align-content-start quicksand">';
						echo '<div class="container">';
							echo 'Sắp xếp theo giá:';
							echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort=ASC&page=1" id="sort" class="btn btn-dark">Tăng dần</a>';
							echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort=DESC&page=1" id="sort" class="btn btn-dark">Giảm dần</a>';
						echo '</div>';
					echo '</div>';
				echo "</div>";
			echo '</div>';
			echo '<div class="container-fluid">';
				...
				$sql="select * from sanpham where NhaSanXuat='".$nsx."' order by MaSP DESC LIMIT ".$page_first_result.",".$result_per_page;
				$result=mysqli_query($ketnoi,$sql);
				...
				while($row=mysqli_fetch_array($result)){
					echo '<div class="card block wow animate__fadeIn">';
						...
						if(isset($_SESSION['username'])){
							echo '<div>';
								echo '<a href="buy-now.php?SP='.$row['MaSP'].'" class="btn btn-block buy-now button">mua ngay</a>';
							echo '</div>';
							echo '<div>';
								echo '<a href="add-to-cart.php?SP='.$row["MaSP"].'" class="btn btn-block add-to-cart button">thêm vào giỏ</a>';
							echo '</div>';
						}else{
							echo '<div>';
			...
			if($page>1){
				...
				echo '<li class="page-item">';
					...
					echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page=1" class="page-link">Đầu</a>';
				echo '</li>';

				//Hiển thị nút Previous
				echo '<li class="page-item">';
				echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page='.$previous.'" class="page-link">&larr;</a>';
				echo '</li>';
				...
				for($i=$page-4;$i<$page;$i++){
					if($i>0){
						...
						echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page='.$i.'" class="page-link">'.$i.'</a>';
						echo '</li>';
					}
				}
			}else{
			...
			echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page='.$page.'" class="page-link">'.$page.'</a>';
			echo '</li>';
			...
			if($page!=$number_of_pages){
				...
				//Hiển thị nút Next
				echo '<li class="page-item">';
				echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page='.$next.'" class="page-link">	&rarr;</a> ';
				echo '</li>';

				//Hiển thị nút chuyển đến page cuối
				echo '<li class="page-item">';
				echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&page='.$number_of_pages.'" class="page-link">Cuối</a>';
				echo '</li>';
			}else{
				//Hiển thị nút Next
				echo '<li class="page-item disabled">';
		...
		echo '</div>';
			...
			echo '<div class="container-fluid">';
				...
				//Định nghĩa cho hàm LIMIT của SQL
				$page_first_result=($page-1)*$result_per_page;
				$sql="select * from sanpham where NhaSanXuat='".$nsx."' order by GiaTien ".$sort." LIMIT ".$page_first_result.",".$result_per_page;
				$result=mysqli_query($ketnoi,$sql);
			...
			if($page>1){
				...
				echo '<li class="page-item">';
					...
					echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort='.$sort.'&page=1" class="page-link">Đầu</a>';
				echo '</li>';

				//Hiển thị nút Previous
				echo '<li class="page-item">';
				echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort='.$sort.'&page='.$previous.'" class="page-link">&larr;</a>';
				echo '</li>';
				...
				for($i=$page-4;$i<$page;$i++){
					if($i>0){
						...
						echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort='.$sort.'&page='.$i.'" class="page-link">'.$i.'</a>';
						echo '</li>';
					}
				}
			}else{
			...
			//Hiển thị nút chuyển page hiện hành
			echo '<li class="page-item active">';
			echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort='.$sort.'&page='.$page.'" class="page-link">'.$page.'</a>';
			echo '</li>';
			...
			if($page!=$number_of_pages){
				...
				//Hiển thị nút Next
				echo '<li class="page-item">';
				echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort='.$sort.'&page='.$next.'" class="page-link">	&rarr;</a> ';
				echo '</li>';

				//Hiển thị nút chuyển đến page cuối
				echo '<li class="page-item">';
				echo '<a href="'.$_SERVER['PHP_SELF'].'?camera='.$nsx.'&sort='.$sort.'&page='.$number_of_pages.'" class="page-link">Cuối</a>';
				echo '</li>';
			}else{
				//Hiển thị nút Next
				echo '<li class="page-item disabled">';
