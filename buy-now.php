	 					...
	 					<div class="container mb-3">
	 						<table border="1" width="100%">
	 							...
	 							<tr>
	 								...
	 								<td>
	 									<p style="font-size: 130%; color: red;"><?php echo number_format($sanpham['GiaTien'],'0',',','.'); ?></p>
	 								</td>
	 							</tr>
	 						</table>
	 					</div>
	 						...
	 						<div class="row">
	 							<div class="col">
	 								<div class="form-group">
	 									...
	 									<input type="text" name="hoten" placeholder="Họ tên" required="" class="form-control" value="<?php echo $khachhang['HovaTen'] ?>">
	 								</div>
	 							</div>
	 						</div>
	 						<div class="row">
	 						...
	 						<div class="row">
	 							<div class="col">
	 								<div class="form-group">
	 									...
	 									<input type="date" name="namsinh" required="" class="form-control" value="<?php echo $khachhang['NamSinh'] ?>">
	 								</div>
	 							</div>
	 						</div>
	 						<div class="row">
	 							<div class="col">
	 								<div class="form-group">
	 									...
	 									<input type="text" name="sdt" placeholder="Số điện thoại" required="" id="sdtID" class="form-control" value="<?php echo $khachhang['SDT'] ?>">
