...
<head>
	...
	<?php echo '<title>Máy ảnh '.$row['TenSP'].'</title>'; ?>
		...
		<div class="row">
			<div class="container" style="background-color: white">
				<div class="row" style="background-color: orange">
					<p class="tenSP"><?php echo $row['TenSP']; ?></p>
				</div>
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 p-2 thongtin">
						<div class="container card pb-4">
							<div class="row mt-3">
								<div class="col">
									<b>Mã sản phẩm: <?php echo $row['MaSP']; ?></b>
								</div>
							</div>
							<div class="row mt-3">
								<div class="col">
							...
							<div class="row mt-3">
								<div class="col">
									<p class="gia">Giá: <?php echo number_format($row['GiaTien'],'0',',','.'); ?> VNĐ</p>
								</div>
							</div>
				...
				<div class="row">
					<div class="col">
						<div class="container card">
							<div class="content"><?php echo $row['MoTaTomTat']; ?></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col">
						<div class="container card mb-4">
							<div class="content"><?php echo $row['MoTaChiTiet']; ?></div>
						</div>
					</div>
				</div>
			</div>
