<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top" id="navbar">
	<div class="container-fluid">
		<a href="index.php" style="text-decoration: none; color: black;">
			<span>
				<img src="./images/logo.png" height="40" width="80" alt="">
			</span>
		</a>
		...
		<div class="collapse navbar-collapse text-center" id="navbarResponsive">
			<ul class="ml-auto navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link" href="index.php#sanpham">Sản Phẩm</a>
				</li>
				<?php 
					if(!isset($_SESSION['role'])){
						...
						echo '<li class="nav-item">
						<a class="nav-link" href="trangcanhan.php">'.$_SESSION['username'].'</a>
						</li>';
						echo '<li class="nav-item">
